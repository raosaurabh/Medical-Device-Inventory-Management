...
public class ManageUserAccountJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Manage User Account Work Area");
    ...
    private void createUserJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createUserJButtonActionPerformed
        if (nameJTextField.getText().length()>0|| passwordJTextField.getText().length()>0) {
            ...
            System.out.println("Organization is " +organization+ "EmployeeName "+employee+ "Username" +userName+ "Password :" +password);
